	...
	<div class="container_lzt">
            ...
            <div class="row">
                ...
                <div class="col-sm-8 col-md-8">
                        ...
                        <div class="row">
                        		<div class="col-md-12">
                        			<div class="alert alert-danger Blank_mandatory_fields" style="display: none;">Please fill all mandatory questions marked with *.</div>
                                    <div class="alert alert-danger special_character" style="display: none;">Please enter the correct value of FirstName</div>
                                    <div class="alert alert-danger special_character_lname" style="display: none;">Please enter the correct value of LastName</div>
                                    <div class="alert alert-danger special_character_orgName" style="display: none;">Please enter the correct value of Current Organization</div>
                                    <div class="alert alert-danger Invalid_email" style="display: none;">Enter a valid and active email address. Example: abc@example.com.</div>
									<div class="alert alert-danger Invalid_age" style="display: none;">Please Enter correct age. Hint: Age must be above 18</div>
                                		<div class="about_panelist bg-white border p-3 mt-5 pt-5 position-relative">
                                        		
                                                <div class="form-input">
                                                
                                                <form:form action="updateForm/${employeeDetails.userInfoId}" method="post" modelAttribute="employeeDetails">
                                                        ...
                                                        <tr>
                                                        	...
                                                        	<td><form:select path="day">
																...
																<form:option value="${data.genericVal}">${data.genericVal}</form:option>
																</c:forEach>
														</form:select> 
                                                    ...
                                                    <button class="btn btn-info" type="submit" value="update" onclick="return validateQueryForm()" >SAVE</button>
                                                    </div>
                                                    </form:form>
                                                </div>
