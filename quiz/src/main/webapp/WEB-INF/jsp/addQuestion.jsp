        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
					<div class="alert alert-danger Blank_mandatory_fields col-md-10" style="display: none;">Please fill all mandatory questions marked with *.</div>
                    <!-- Page Heading -->
                    ...
                    <div class="row">
                        ...
                        <form:form method="post" action="savequestion" modelAttribute="questionWithAnswer">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table border">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>Answer 1<sup class="text-red">*</sup></td>
                                                    <td><form:input type="text" placeholder="Enter Answer..." path="ansList[0].answer" class="form-control"/> </td>
                                                    <td class="text-center">
                                                        <form:radiobutton value="1" path="correctAnswerId" name="answerradio" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Answer 2<sup class="text-red">*</sup></td>
                                                    <td><form:input type="text" placeholder="Enter Answer..." path="ansList[1].answer" class="form-control"/> </td>
                                                    <td class="text-center">
                                                        <form:radiobutton value="2" path="correctAnswerId" name="answerradio" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Answer 3<sup class="text-red">*</sup></td>
                                                    <td><form:input type="text" placeholder="Enter Answer..." path="ansList[2].answer" class="form-control" /> </td>
                                                    <td class="text-center">
                                                        <form:radiobutton value="3" path="correctAnswerId" name="answerradio" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Answer 4<sup class="text-red">*</sup></td>
                                                    <td><form:input type="text" placeholder="Enter Answer..." path="ansList[3].answer" class="form-control" /> </td>
                                                    <td class="text-center">
                                    ...
                                    <div class="col-12 mt-3 text-center">
                                        <button class="btn btn-primary px-5" type="submit" onclick="return validateQueForm();">Save</button>
                                    </div>
                                </div>
                            </div>
                            </form:form>
